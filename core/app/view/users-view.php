    ...
    <div class="col-md-12">
        <div class="d-flex align-items-center mb-4">
            <div>
                ...
                <p class="text-muted mb-0">Administra cuentas de acceso y permisos del sistema</p>
            </div>
            <div class="ms-auto">
                    ...
                    <table class="table table-hover align-middle mb-0 datatable">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-indigo-100 text-indigo-700 rounded-pill px-3"><?php echo $rol->name; ?></span>
                                </td>
                                <td>
                                    <?php if($u->is_active): ?>
            ...
            <form id="add-user-form">
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <label class="form-label small fw-bold">Rol / Perfil *</label>
            ...
            <form id="edit-user-form">
                ...
                <div class="modal-body p-4">
                    <div class="row g-3">
                        ...
                        <div class="col-md-12">
                            <label class="form-label small fw-bold">Rol / Perfil *</label>
                            <select name="rol_id" id="edit_user_rol_id" class="form-select" required>
                                <?php foreach($roles as $r): ?>
                                    <option value="<?php echo $r->id; ?>"><?php echo $r->name; ?></option>
                                <?php endforeach; ?>
                            </select>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.editUser = function(id) {
        ...
        .then(res => res.json()).then(u => {
            ...
            document.getElementById('edit_user_rol_id').value = u.rol_id;
